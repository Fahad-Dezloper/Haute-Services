...
const published_articles = [
    {
        ...
        excerpt: "An exploration of fine art as both an emotional pursuit and a long-term investment in the evolving Indian art market.",
    ...
    },
    {
        ...
        excerpt: "A journey through the evolution of Indian visual art, from royal patronage to modern and contemporary practices.",
        ...
        <main className="bg-cream min-h-screen text-charcoal font-sans selection:bg-charcoal selection:text-white overflow-hidden">
                        ...
                        <div className="grid lg:grid-cols-2 gap-12 lg:gap-24 items-end">
                            ...
                            <Reveal delay={0.2}>
                                <div className="space-y-6 text-base lg:text-lg text-charcoal/70 font-light leading-relaxed max-w-xl">
                                    <p>
                                        At Haute Services, art advisory is a deeply personal consultancy. We recognize that art is more than decoration; it is an asset class, a cultural statement, and a reflection of identity.
                                    </p>
                                    <p>
                                        With over a decade of experience in our culturally rich verticals, we operate as boutique advisors for discerning private collectors and corporate headquarters.
                                    </p>
                                </div>
                            </Reveal>
                        </div>
            ...
            <section className="bg-white">
                            ...
                            <div className="lg:col-span-6 lg:order-2">
                                <Reveal>
                                    <div className="flex items-center gap-4 mb-6">
                                        ...
                                        <span className="text-[10px] uppercase tracking-[0.4em] font-bold text-charcoal/40">Exclusive Offerings</span>
                                    </div>
                                    ...
                                    <ul className="space-y-8 lg:space-y-12">
                                        {[
                                            { title: "Curation of Art Shows & Events", desc: "Crafting immersive experiences that bridge artists and collectors." },
                                            { title: "Sale & Purchase of Artworks", desc: "Expert market insight for seamless acquisition and divestment." },
                                            { title: "Art Restoration Services", desc: "Specialized care for historical and contemporary masterpieces." },
                                            { title: "Portfolio Valuation & Management", desc: "Strategic oversight for investment-grade art assets." }
                                        ].map((item, i) => (
                    ...
                    <div className="container mx-auto px-6 py-20 lg:py-32">
                        <div className="items-center">
                            <div className="w-full">
                                <Reveal>
                                    <h2 className="text-4xl md:text-5xl lg:text-7xl font-serif mb-6 text-charcoal leading-tight">Expertise <span className="font-light">&</span> <span className="italic font-light">Specializations</span></h2>
                                    <p className="text-lg lg:text-xl text-charcoal/70 mb-12 lg:mb-16 font-light leading-relaxed max-w-4xl">
                                        We specialize in a broad spectrum of visual arts, ensuring our clients have access to the most significant movements in the art world.
                                    </p>
                ...
                <div className="relative border-b border-charcoal/5">
                    <div className="container mx-auto px-6 lg:px-12 py-20 lg:py-32">
                        <Reveal>
                            <h2 className="text-4xl md:text-5xl lg:text-7xl font-serif mb-6 lg:mb-8 text-charcoal leading-tight text-center">Curated <span className="italic font-light">Spaces</span></h2>
                            <p className="text-lg lg:text-xl text-charcoal/70 mb-12 lg:mb-20 font-light leading-relaxed max-w-3xl mx-auto text-center">
                                From intimate private residences to expansive corporate environments, we redefine how art interacts with physical space.
                            </p>
                        </Reveal>
                                    ...
                                    <div className="group cursor-pointer">
                                        ...
                                        <div className="flex items-end justify-between border-b border-charcoal/10 pb-6">
                                            <div className="space-y-2">
                                                <span className="text-[10px] uppercase tracking-[0.4em] font-bold text-charcoal/30">Project Vertical</span>
                                                <h3 className="text-2xl lg:text-4xl font-serif text-charcoal group-hover:italic transition-all duration-500">
                                                    {item.title}
                                                </h3>
                                            </div>
                                            <span className="text-sm font-light text-charcoal/40 group-hover:text-charcoal transition-colors">0{i + 1}</span>
                                        </div>
                                    </div>
                                </Reveal>
                            ))}
                            ...
                            <Reveal key={index} delay={index * 0.1}>
                                <div className="h-full bg-white border border-charcoal/5 group hover:border-charcoal/20 transition-all duration-500 flex flex-col overflow-hidden shadow-sm hover:shadow-xl">
                                    ...
                                    <div className="p-6 lg:p-8 flex-1 flex flex-col">
                                        <span className="text-[10px] uppercase tracking-[0.3em] font-bold text-charcoal/40 mb-4 block">{item.type}</span>
                                        <h3 className="text-xl lg:text-2xl font-serif mb-4 leading-tight group-hover:italic transition-all duration-500">{item.title}</h3>
                                        <p className="text-sm text-charcoal/70 leading-relaxed font-light mb-8 flex-1">
                                            {item.desc}
                                        </p>
                                        <div className="pt-4 border-t border-charcoal/5 text-[10px] uppercase tracking-widest font-bold text-charcoal/60">{item.location}</div>
                                    </div>
                                </div>
                            </Reveal>
                        ))}
                ...
                <div className="max-w-7xl mx-auto">
                    <Reveal>
                        <div className="text-center mb-16 lg:mb-24">
                            ...
                            <h2 className="text-4xl md:text-5xl lg:text-7xl font-serif text-charcoal leading-none">Published <span className="italic font-light">Articles</span></h2>
                        </div>
                    </Reveal>
                                ...
                                <div className="group cursor-pointer flex flex-col h-full border-b border-charcoal/5 pb-10 lg:pb-12">
                                    ...
                                    <div className="flex-1 space-y-4">
                                        <div className="flex items-center justify-between text-[10px] uppercase tracking-[0.3em] font-bold text-charcoal/40">
                                            <span>{item.publication} <span className="opacity-30 mx-2">|</span> {item.section}</span>
                                            <span>{item.date}</span>
                                        </div>
