  ...
  return (
    <main className="bg-cream min-h-screen text-charcoal font-sans selection:bg-charcoal selection:text-white overflow-hidden pb-12">
        ...
        <div className="relative z-10 w-full max-w-7xl mx-auto">
          <Reveal>
            ...
            <p className="text-base md:text-lg text-white/70 max-w-xl font-light leading-relaxed border-l border-white/20 pl-6 uppercase tracking-widest text-[10px]">
              Celebrating excellence, innovation, and leadership in hospitality,
                ...
                <div className="w-full lg:w-1/2 space-y-8">
                  <div className="space-y-4">
                    <div className="flex items-center gap-3">
                      ...
                      <span className="text-xs uppercase tracking-[0.3em] font-bold text-charcoal/40">
      ...
      <section className="py-24 lg:py-40 bg-white border-y border-charcoal/5 text-center px-6">
        <Reveal>
          <div className="max-w-3xl mx-auto space-y-8">
            <Trophy
              className="w-12 h-12 text-charcoal/10 mx-auto"
              strokeWidth={1}
            />
            ...
            <p className="text-xs uppercase tracking-[0.5em] font-bold text-charcoal/30">
              Haute Services Philosophy
            </p>
          </div>
        </Reveal>
      </section>
      ...
      <section className="py-24 lg:py-40 px-6 text-center">
        <Reveal>
          <h2 className="text-4xl lg:text-6xl font-serif text-charcoal mb-12">
            Crafting <span className="italic">award-winning</span> narratives.
          </h2>
          <a
            href="mailto:info@hauteservices.in"
            className="inline-flex items-center gap-4 bg-charcoal text-white px-10 py-5 hover:bg-charcoal/80 transition-all font-serif italic text-xl group"
          >
            Work With Us
