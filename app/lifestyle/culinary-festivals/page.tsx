...
import { ArrowLeft, Globe, Utensils, Award, Users, MapPin, Play, Newspaper, BookOpen, Quote, ArrowUpRight, X, Facebook, Instagram } from 'lucide-react';
    ...
    const testimonials = [
        {
            ...
            quote: "A magnificent celebration of the diversity and richness of South Asian flavors. FFTF bridges cultures through the universal language of food."
        },
        {
            name: "Chef Ranveer Brar",
            role: "Masterchef India Judge & Culinary Artist",
            image: "/food/ranveer.webp",
            quote: "Food For Thought Fest is where the soul of our cuisine finds its voice. It’s a podium that respects tradition while embracing the future."
        }
    ];
    ...
    const yearBlocks = [
        {
            year: "2025",
            videos: [
                { channel: "NDTV GoodTimes", title: "Food For Thought Fest 2025 Coverage", id: "7m9aXi6u7V0" }
            ]
        },
        {
            year: "2024",
            videos: [
                { channel: "News Coverage", title: "Ahmedabad Food Festival Inauguration", id: "QboCWHUaNXU" }
            ]
        },
        {
            year: "2022",
            videos: [
                { channel: "NewsX", title: "Cuisine, Culture, Conversations Galore", id: "GVJ2nOSuLGc" }
            ]
        },
        {
            year: "2019",
            videos: [
                { channel: "FFTF", title: "Food For Thought Fest 2019 - A Round Up", id: "HTA6-6rVlfs" },
                { channel: "SAAG", title: "5th Edition at GMR Square, Aerocity", id: "T7-eLwtWXSc" },
                { channel: "NDTV", title: "Series Highlight: 2015 - 2019", id: "Ig9p8cR5ssA" }
            ]
        },
        {
            year: "2018",
            videos: [
                { channel: "SAAG", title: "Special Coverage: Food for Thought Fest 2018", id: "O_iNrsPyJtI" }
            ]
        },
        {
            year: "2017",
            videos: [
                { channel: "NDTV", title: "Food For Thought Fest 2017 - Part 1", id: "QQBsp0oR6kE" },
                { channel: "NDTV", title: "Food For Thought Fest 2017 - Part 2", id: "c5Cb6LnQArU" }
            ]
        },
        {
            year: "2016",
            videos: [
                { channel: "NDTV Good Times", title: "Food For Thought Fest 2016 Coverage", id: "4KvqQez_tCU" }
            ]
        },
        {
            year: "2015",
            videos: [
                { channel: "NDTV", title: "Food For Thought Fest 2015 Coverage", id: "1gvSMnuxI-U" },
                { channel: "Associated Press", title: "Global Feature: FFTF 2015", id: "cYpRQumfblg" }
            ]
        }
    ];
            ...
            <section className="py-24 lg:py-40 px-6 lg:px-12 max-w-7xl mx-auto">
                <div className="grid md:grid-cols-12 gap-12 lg:gap-16 items-start mb-32">
                    <div className="md:col-span-11 lg:col-span-8">
                        <Reveal>
                            <span className="text-xs uppercase tracking-[0.4em] font-bold text-charcoal/30 mb-6 block">Our Flagship Event</span>
                            ...
                            <p className="text-xl lg:text-3xl text-charcoal/80 font-serif leading-relaxed mb-12">
                                "The defining platform for culinary unity and excellence across the South Asian subcontinent."
                            </p>
                        </Reveal>
                        <Reveal delay={0.2}>
                            <div className="space-y-8 text-lg text-charcoal/70 font-light leading-relaxed max-w-3xl">
                                <p>
                                    Founded in 2015 by SAAG (South Asian Association for Gastronomy), Food For Thought Fest has evolved into the authoritative platform for South Asian gastronomy. It is the only event from the region to be featured four times by the <strong>Associated Press (A.P.)</strong>.
                                </p>
                                <div className="py-12 bg-white flex flex-col items-center justify-center border border-charcoal/5 shadow-sm my-12 md:my-16 relative overflow-hidden group max-w-md mx-auto lg:mx-0">
                                    <Image src="/food/SAAGAWARD.avif" alt="SAAG Award" height={240} width={240} className="w-40 md:w-52 h-40 md:h-52 text-charcoal/20 mb-6 group-hover:scale-105 transition-transform duration-700" />
                                    <h4 className="text-lg md:text-xl font-serif mb-3 text-center text-charcoal">"Food Festival of the Year 2019"</h4>
                                    <p className="text-[9px] md:text-[10px] text-charcoal/50 uppercase tracking-[0.2em] font-bold">National Gastronomy Recognition</p>
                                </div>
                                <p>
                ...
                <div className="grid md:grid-cols-2 gap-8 lg:gap-12 bg-charcoal text-white py-16 px-6 md:p-16 lg:p-24 rounded-sm overflow-hidden relative mb-40">
                    <Reveal>
                        <h3 className="text-2xl md:text-3xl font-serif mb-12">The Impact</h3>
                        <div className="grid grid-cols-2 gap-y-12 md:gap-y-16 gap-x-8 md:gap-x-12">
                            {[
                                ...
                                <div key={i}>
                                    <span className="block text-4xl md:text-5xl lg:text-7xl font-light mb-3">{stat.val}</span>
                                    <span className="text-[9px] md:text-[10px] uppercase tracking-widest text-white/40 font-bold">{stat.label}</span>
                                </div>
                            ))}
                        </div>
                    </Reveal>
                            ...
                            <Reveal key={i} delay={i * 0.1}>
                                <div className="relative pt-20 border-t border-charcoal/10">
                                    ...
                                    <div className="space-y-1">
                                        <h4 className="text-base md:text-lg font-bold uppercase tracking-widest">{t.name}</h4>
                                        <p className="text-[10px] md:text-xs text-charcoal/40 uppercase tracking-widest font-bold">{t.role}</p>
                                    </div>
                                </div>
                            </Reveal>
                        ))}
                                ...
                                <div className="group space-y-4 sm:space-y-10">
                                    ...
                                    <div className="space-y-3 sm:space-y-8">
                                        ...
                                        <div className="pt-2 sm:pt-4 items-center gap-2 sm:gap-4 group-hover:gap-6 transition-all duration-500 opacity-0 group-hover:opacity-100 hidden sm:flex">
                                            ...
                                            <span className="text-[8px] sm:text-[10px] uppercase tracking-widest font-bold">Read Detail</span>
                                        </div>
                                    </div>
                                </div>
                            </Reveal>
                ...
                <div className="grid bg-charcoal text-white py-16 md:py-24 px-8 md:px-16 my-24 md:grid-cols-2 gap-12 lg:gap-16 items-center rounded-sm">
                    <Reveal>
                        <div className="space-y-8">
                            <h3 className="text-3xl lg:text-5xl font-serif leading-tight">Global Impact</h3>
                            <p className="text-lg lg:text-xl text-white/60 font-light leading-relaxed">
                                Food For Thought Fest remains the only South Asian festival featured four times by the Associated Press (A.P.) global wires, solidifying its place as a cultural milestone in the region.
                            </p>
                        </div>
                    </Reveal>
                    <Reveal delay={0.2}>
                        <div className="hidden md:block p-10 lg:p-12 bg-white/5 border border-white/10 rounded-sm italic text-xl lg:text-2xl font-serif text-white/80">
                            "More than just food, it's about the stories, the people, and the shared heritage that connects us all."
                        </div>
                    </Reveal>
                </div>
                        ...
                        <div className="flex flex-col lg:flex-row lg:items-end justify-between mb-16 gap-8 border-b border-charcoal/10 pb-12">
                            ...
                            <div className="max-w-md lg:text-right">
                                <p className="text-lg text-charcoal/60 font-light leading-relaxed">
                                    A decade of Food For Thought Fest captured across South Asia's leading national television networks and premier news channels.
                                </p>
                            </div>
                        </div>
                    </Reveal>
